...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/TahaNadeemkhan/ai-native-book-of-robotics/tree/master/docusaurus/',
        },
        blog: false, // Disabled - no blog content
        theme: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Native Book | Physical AI & Humanoid Robotics`,
    },
    prism: {
